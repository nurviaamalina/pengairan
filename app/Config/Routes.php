...
| - Admin
|
| User tidak dapat mengakses route admin umum.
|
*/

$routes->group(
    'admin',
    ['filter' => 'role:superadmin,admin'],
    function ($routes) {
        ...
        */
        ...
        $routes->get(
            ...
            'Admin\ManajemenUser::create'
        );

        $routes->post(
            'manajemen-user/store',
            'Admin\ManajemenUser::store'
        );

        $routes->get(
            'manajemen-user/edit/(:num)',
            'Admin\ManajemenUser::edit/$1'
        );

        $routes->post(
            'manajemen-user/update/(:num)',
...
$routes->group(
    ...
    ['filter' => 'role:superadmin,admin,user'],
    function ($routes) {
