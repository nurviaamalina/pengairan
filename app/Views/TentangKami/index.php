...
<section class="hero-about">
    ...
    <img 
        src="<?= base_url('assets/images/batik.png') ?>" 
        class="motif-kiri" 
        alt="Motif"
    >
        ...
        <div class="content-card">
            ...
            <?php else: ?>
                ...
                >
                    ...
                    Silakan admin menginput data sejarah
                    di halaman admin.
...
>
    ...
    <div class="container text-center">
        ...
        <div class="struktur-card">
            ...
            $strukturPath = !empty($profil['struktur'])
                ? FCPATH . 'uploads/struktur/' . $profil['struktur']
                : '';
            ...
            <?php if (
                !empty($profil) &&
                !empty($profil['struktur']) &&
                file_exists($strukturPath)
            ): ?>
            ...
            <?php else: ?>
                ...
                >
                    ...
                    Gambar struktur saat ini masih menggunakan
                    gambar default. Admin dapat mengupload
                    gambar struktur baru di halaman admin.
...
<!-- ============================================================
     SCROLL OFFSET
     Agar judul tidak tertutup navbar saat menggunakan #
============================================================ -->
