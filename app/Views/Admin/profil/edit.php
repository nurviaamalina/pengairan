...
.form-actions .btn-kembali:hover {
    background: #1a2a5a;
    color: #fff;
    transform: translateY(-2px);
}
...
.form-actions .btn-update i,
.form-actions .btn-kembali i {
    font-style: normal !important;
}
        ...
        <div class="p-4 flex-grow-1">
            ...
            <div class="user-page-header">
                ...
                <div>
                    ...
                    <p>
                        Edit informasi profil Dinas Pengairan
                    </p>
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <!-- FORM HANYA SATU -->
                    <form
                        action="<?= base_url('admin/profil/update/'.$profil['id']) ?>"
                        method="post"
